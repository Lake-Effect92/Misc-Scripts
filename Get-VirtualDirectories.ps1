...
foreach ($server in $servers) {
    ...
    Get-ClientAccessServer -Identity $server | Select-Object Name, AutoDiscoverServiceInternalUri | ForEach-Object {
        Write-Host "Client Access Server URLs:"
        Write-Host "Name: $($_.Name)"
        Write-Host "AutoDiscoverServiceInternalUri: $($_.AutoDiscoverServiceInternalUri)"
        Write-Host "---------------------------"
    }
